...
def test_dashboard_contains_operator_queue_panel(monkeypatch):
    ...
    monkeypatch.setattr(dashboard, "build_operator_briefing", lambda **kwargs: {
        ...
        "suggested_next_steps": ["Review queue"],
    })
    ...
    monkeypatch.setattr(dashboard, "build_operator_queue", lambda **kwargs: [
        {
            ...
            "blocking_factors": [],
            "created_at": "2026-04-18_18-00-00",
            "updated_at": "2026-04-18_18-00-00",
        }
    ])
    ...
    assert "Operator Queue / Case Board" in html
