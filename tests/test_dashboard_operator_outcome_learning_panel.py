...
def test_dashboard_contains_learning_snapshot_section(monkeypatch):
    ...
    monkeypatch.setattr(dashboard, "summarize_operator_resolution_quality", lambda *args, **kwargs: {
        "resolution_quality": {"durable": 0, "mostly_stable": 0, "fragile": 0, "likely_to_reopen": 0, "insufficient_resolution": 0},
        "durable_closures": [],
        "fragile_closures": [],
        "likely_reopeners": [],
    ...
    monkeypatch.setattr(dashboard, "summarize_operator_improvement_plans", lambda *args, **kwargs: {
        "priority_counts": {"critical": 0, "high": 0, "medium": 0, "low": 0, "maintenance": 0},
        "improvement_plans": [],
